...
from lib.datasets import make_data_loader, make_feat_data_loader
from lib.utils.net_utils import load_model, save_model, load_network
from lib.evaluators import make_evaluator
from lib.evaluators import make_evaluator
from lib.feature_generator import make_feat_gen
...
def train(cfg, network):
    ...
    feat_loader, cam_bbox = make_feat_data_loader(cfg, is_distributed=cfg.distributed)
