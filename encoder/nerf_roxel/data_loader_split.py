...
def load_data_split(basedir, scene, feat_h, feat_w, split, 
    skip=1, try_load_min_depth=True, only_img_files=False):
    ...
    for i in range(cam_cnt):
        ...
        ray_samplers.append(RaySamplerSingleImage(H=H, W=W, feat_h=feat_h, feat_w=feat_w, 
